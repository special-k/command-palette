  ...
  activate () {
    ...
    this.disposables.add(atom.commands.add('atom-workspace', {
      ...
      'command-palette:show-with-prefix': () => {
        this.commandPaletteView.show(false, true)
      }
    }))
    ...
    this.disposables.add(atom.config.observe('command-palette.defaultCommandPath', (newValue) => {
      this.commandPaletteView.update({defaultCommandPath: newValue})
    }))
